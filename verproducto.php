...
<form role="form" method="post" id="agregar">
  ...
  <div class="form-group">
    ...
    <input type="tex" class="form-control" name="email" >
  </div>
  <div class="form-group">
...
function loadTabla(){
  ...
  $.get("./php/tablaproducto.php","",function(data){
    $("#tabla").html(data);
  })
...
$("#buscar").submit(function(e){
  e.preventDefault();
  $.get("./php/busquedaproducto.php",$("#buscar").serialize(),function(data){
    $("#tabla").html(data);
  $("#buscar")[0].reset();
  });
});
...
loadTabla();
  ...
  $("#agregar").submit(function(e){
    e.preventDefault();
    $.post("./php/agregarproducto.php",$("#agregar").serialize(),function(data){
    });
